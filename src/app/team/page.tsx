...
const teamMembers = [
  {
    ...
    socialLinks: {
      linedin: ' https://www.linkedin.com/in/afsheen-imran-b623a42a2/',
  ...
  },
  {
    ...
    image: '/mohsin.jpg',
    expertise: ['Full-Stack Developer', 'UI/UX Designer', 'Web 3.0 & Metaverse', 'Phython Programmer'],
    socialLinks: {
      linedin: 'https://www.linkedin.com/in/mohsin-raza-a514392b6/',
    },
  },
  {
    name: 'Abu Bakar',
    ...
    socialLinks: {
      linedin: 'https://www.linkedin.com/in/abubaker-siddique-4624422b9/',
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  {member.socialLinks.twitter && (
                    <a href={member.socialLinks.twitter} className="text-gray-400 hover:text-purple-400">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {member.socialLinks.github && (
                    <a href={member.socialLinks.github} className="text-gray-400 hover:text-purple-400">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
