      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            ...
            through cutting-edge digital solutions that not only meet but exceed
            the evolving needs of the modern marketplace.
          </p>
            ...
            <div className="space-y-16">
              {[
                ...
                },
                {
                  step: 3,
                  title: "Design",
                  description: "Creating engaging and intuitive solutions",
                },
                {
                  step: 4,
                  title: "Development",
            ...
            <div>
              <ul className="space-y-6">
                <li className="flex items-start">
                  <svg
                    className="w-6 h-6 text-[#4169E1] mt-1 mr-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Our team comprises industry veterans with deep knowledge
                      across various technologies and sectors.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      ...
                      are custom-built to address your unique challenges.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      ...
                      industries, we have the experience to deliver results.
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Join our digital community and stay updated with our latest
              ...
              >
                <div
                  className={`w-24 h-24 rounded-full bg-gradient-to-br ${
                    social.color
                  } p-[2px] transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg group-hover:shadow-${
                ...
                <div className="absolute -bottom-10 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out group-hover:transform group-hover:-translate-y-2">
                  <span className="text-sm font-medium text-white bg-[#0A0F1C] px-3 py-1 rounded-full shadow-md">
                    {social.name}
                  </span>
                </div>
              </Link>
